      ...
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            <div style="color: #666666FF; margin-top: 5px">Sales Volume：${{goodsData.count}}</div>
            <div style="color: #ff618c; margin-top: 15px">Negotiate Price：<span style="font-size: 20px">${{goodsData.price}} / {{goodsData.unit}}</span></div>
            <div style="margin-top: 20px">
              <img src="@/assets/imgs/right.png" alt="" style="width: 70%; height: 130px; border-radius: 15px">
            </div>
            <div style="color: #666666FF; margin-top: 20px">Shop：<a href="#" @click="navTo('/front/business?id=' + goodsData.businessId)">{{goodsData.businessName}}</a></div>
            ...
            <div style="color: #666666FF; margin-top: 20px">
              ...
              <el-button type="warning" @click="collect">Save</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
